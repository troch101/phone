...
$(function(){
	 ...
	 $("#music").append(
                    '<audio id="bgMusic" src="http://pp2d9b1ul.bkt.clouddn.com/old%20fotos.mp3" autoplay loop  hidden></audio>'
                );
		$(".no").click(function() {
			$(".no").css('display','none');
    ...
    function readFile(){   
        ...
        for(var i=0;i<iLen;i++){  
            ...
            reader.onload = function(e){   
                ...
                div['className'] = 'float';  
                document.getElementById('imagesfile').appendChild(div);  　　//插入dom树    
